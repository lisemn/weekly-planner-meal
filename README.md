...
- Weekly food budget setting
- Weekly meal plan generation
- Recipe management
- Custom recipe support
- Shopping list generation
- Basic nutrition information
- Health warning or suggestion display
...
4. The application will run locally in the browser.

No additional installation is required for the basic version of this project.

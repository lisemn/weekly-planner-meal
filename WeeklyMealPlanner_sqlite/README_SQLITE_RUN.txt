...
What's in
---------
- index.html: main page structure for login, dashboard, recipes, shopping list, meal prep, profile, and preferences.
- style.css: visual layout, colours, cards, buttons, navigation, modals, and responsive design.
- app.js: front-end logic for meal plans, recipes, serving size, measurement units, meal completion, shopping list, reviews, and SQLite data sync.
- server.js: local Node.js server that runs the website and connects the front end to SQLite.
- schema.sql: database table setup used to create the SQLite structure.
